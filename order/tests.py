...
class TestOrderModel(TestCase):
    ...
    def setUp(self):
        ...
        with mock.patch('django.utils.timezone.now') as mock_time:
            ...
            self.order1 = Order(id=101, user=self.user, book=self.book1, planned_end_at=TEST_DATE)
            self.order1.save()
            self.order2 = Order(id=102, user=self.user, book=self.book2, planned_end_at=TEST_DATE)
            self.order2.save()
            self.order3 = Order(id=103, user=self.user, book=self.book3, end_at=TEST_DATE_END, planned_end_at=TEST_DATE)
            self.order3.save()

    def test__str__end_at_is_None(self):
        """Test of the CustomUser.__str__() method"""
        order_returned = str(Order.objects.get(id=101))
        order_to_expect = "'id': 101, 'user': CustomUser(id=111), 'book': Book(id=101), 'created_at': '2017-04-10 12:00:00+00:00', 'end_at': None, 'planned_end_at': '2017-04-10 12:00:00+00:00'"
    ...
    def test__str__end_at_is_not_None(self):
        ...
        order_to_expect = "'id': 103, 'user': CustomUser(id=111), 'book': Book(id=103), 'created_at': '2017-04-10 12:00:00+00:00', 'end_at': '2017-04-25 12:00:00+00:00', 'planned_end_at': '2017-04-10 12:00:00+00:00'"
    ...
    def test_get_by_id_positive(self):
        ...
        self.assertEqual(order.planned_end_at, TEST_DATE)
    ...
    def test_create_positive(self):
        ...
        with mock.patch('django.utils.timezone.now') as mock_time:
            ...
            self.assertEqual(order.planned_end_at, TEST_DATE_END)
    ...
    def test_update_planned_end_at(self):
        ...
        self.assertEqual(order.created_at, TEST_DATE)
        self.assertEqual(order.end_at, None)
        self.assertEqual(order.planned_end_at, new_date)
