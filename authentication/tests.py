...
class TestCustomUserModel(TestCase):
    ...
    def test_create_positive(self):
        ...
        with mock.patch('django.utils.timezone.now') as mock_time:
            mock_time.return_value = time_mock
            user_returned = CustomUser.create('email_new@mail.com', '1234', 'fname', 'lname')
    ...
    def test_create_negative_long_first_name(self):
        ...
        user_returned = CustomUser.create('email_new@mail.com', '1234', 'f' * 21, 'lname')
        self.assertIsNone(user_returned)

    def test_create_negative_long_last_name(self):
        """ Negative Test of the CustomUser.create() method """
        user_returned = CustomUser.create('email_new@mail.com', '1234', 'fname', 'l' * 21)
        self.assertIsNone(user_returned)

    def test_create_negative_not_valid_email(self):
        """ Negative Test of the CustomUser.create() method """
        expect_none = CustomUser.create('96mail.com', '1234', 'fname', 'lname')
        self.assertIsNone(expect_none)

    def test_create_negative_duplicate_email(self):
        """ Negative Test of the CustomUser.create() method """
        expect_none = CustomUser.create('email@mail.com', '1234', 'fname', 'lname')
        self.assertIsNone(expect_none)
    ...
    def test_update_full(self):
        ...
        user_to_update.update('John', 'Jr.', '123456', 1, True)
    ...
    def test_get_role_name_user(self):
        """ Test of the CustomUser.get_all() method """
        expected_value = CustomUser.objects.get(id=111).get_role_name()
        self.assertEqual('user', expected_value)

    def test_get_role_name_staff(self):
        """ Test of the CustomUser.get_all() method """
        expected_value = CustomUser.objects.get(id=4).get_role_name()
        self.assertEqual('staff', expected_value)
